 ...
 * between pinkdogd, and pinkdog-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/PinkDogOfficial/PinkDog>";
    const std::string URL_WEBSITE = "<https://pinkdog.party>";
...
/** Sanity checks
 *  Ensure that Pinkdog is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Pinkdog process is using the data directory.
